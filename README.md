...
src/
  game/                 logique pure, sans React — voir src/game/CLAUDE.md
    ...
    openingBook.data.ts livre généré hors ligne à profondeur 9, 454 entrées
