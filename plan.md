...
**Le livre d'ouverture reste utile, d'une avance qui se réduit.** Au tout début de partie le plateau offre 60 à 95 coups légaux, et la recherche en direct n'y dépasse pas la profondeur 6. Le livre, calculé hors ligne à profondeur 7, donne l'anticipation qui manque là où elle manque le plus. Deux mesures, au budget du jeu et non au seuil de force qui sert d'ordinaire aux duels. **Coup par coup**, un arbitre commun note le coup du livre et celui du jeu direct à la même profondeur, sur les 50 ouvertures distinctes de l'adversaire : le livre est meilleur 30 fois, à égalité 20, **moins bon zéro fois**, et aucune ouverture ne lui manque. **Partie par partie**, à ouverture imposée et sans aucun aléa, les deux camps étant le même moteur au même budget et seul le premier coup de l'ordinateur changeant : **34 victoires sur 48 avec le livre, 28 sur 48 sans**, soit 12 ouvertures gagnées grâce à lui contre 6 perdues (test des signes p = 0,24).

Cette avance se réduit à mesure que la recherche en direct s'approfondit, et c'est attendu : le livre valait 12 sur 12 contre 6 quand le jeu plafonnait à la profondeur 4 et qu'il en offrait 6 — deux paliers d'avance. Il n'en offre plus qu'**un**. Le livre doit donc gagner un palier chaque fois que le moteur en gagne un, sous peine de ne plus faire que répéter ce que le jeu trouve seul.

Un premier duel sur **12** ouvertures avait rendu 8 contre 10, l'inverse : quatre ouvertures discordantes ne distinguent rien du hasard. C'est la même leçon qu'ailleurs dans ce document — une mesure de force se fait sur une quarantaine de parties appariées, et une mesure trop courte ne se lit pas, dans un sens comme dans l'autre.
