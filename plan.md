...
- **Il ne jette plus le palier qu'il n'a pas fini.** Approfondir coûte cinq à neuf fois le palier précédent : le dernier palier entamé n'a donc presque jamais le temps de finir, et tout ce qui y était passé était perdu — mesuré, quatre à six secondes sur six. Un palier interrompu est désormais retenu lorsqu'il **confirme ou améliore** le précédent, ce qui est le cas ordinaire puisque le meilleur coup du palier précédent y est réexaminé le premier, plus profondément. Un palier qui s'effondre, lui, est écarté : il a trouvé une réfutation sans avoir eu le temps de chercher la parade ailleurs.
...
Ces six secondes sont un **plafond, pas une attente systématique**. Un palier coûte plusieurs fois le précédent : le maître mesure ce que le dernier lui a pris, en déduit ce que coûterait le suivant, et ne s'y engage que s'il a de quoi le finir. Il rend donc son coup dès qu'approfondir n'est plus à sa portée, au lieu de dépenser le reste du budget dans un calcul qu'il jettera. Et dès qu'il peut **résoudre** la partie, il s'arrête sur-le-champ : en fin de partie il répond presque instantanément.
...
**Le livre d'ouverture reste utile.** Au tout début de partie le plateau offre 60 à 95 coups légaux, et la recherche en direct n'y dépasse pas la profondeur 5. Le livre, calculé hors ligne à profondeur 6, donne gratuitement l'anticipation qui manque là où elle manque le plus. Mesuré à ouverture imposée, sur 12 ouvertures distinctes de l'adversaire, sans aucun aléa, les deux camps étant le même moteur au même budget et seul le premier coup de l'ordinateur changeant : **9 victoires sur 12 avec le livre, 7 sur 12 sans**. L'écart s'est resserré à mesure que la recherche en direct s'est approfondie — il valait 12 sur 12 contre 6 sur 12 quand elle plafonnait à la profondeur 4 —, et il se rouvrirait en régénérant le livre avec l'évaluation courante. Le coup du livre n'est jamais moins bon que celui de la recherche en direct lorsqu'on note les deux à profondeur égale ; il est meilleur dans 10 cas sur 12.
