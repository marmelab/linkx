...
**Le maître ne vise pas une profondeur, il consomme un budget.** Les trois premiers niveaux annoncent un nombre de tours d'anticipation et rabattent ce nombre quand le plateau est trop large. Le maître fait l'inverse : il **approfondit par paliers successifs** — un tour, puis deux, puis trois — et joue le résultat du **dernier palier achevé** quand son temps est écoulé. Il a donc toujours un coup sous la main, et il va d'autant plus loin que la position est resserrée ou la machine rapide, sans jamais dépasser son budget. Sur une position de milieu de partie il atteint couramment huit à dix tours d'anticipation, là où son barème précédent en tenait quatre.

Deux conséquences à ne pas perdre :

- **Il ne retient qu'un nombre pair de tours.** Un nombre impair s'arrête juste après un de ses propres coups : il voit son gain sans voir la réponse, et se croit mieux placé qu'il ne l'est. Le biais est massif — mesuré, il fait passer le niveau de huit victoires sur huit contre son barème précédent à quatre sur huit. Comme le budget est en temps, la profondeur atteinte dépend de la machine, et un téléphone lent tomberait sur la mauvaise parité. Les paliers impairs sont donc calculés — ils aident à trier les coups du palier suivant — mais **jamais joués**.
...
Ces six secondes sont un **pire cas d'ouverture**, pas une attente systématique : dès que le maître peut résoudre la partie, il répond en une fraction de seconde. Les longues réflexions se concentrent donc sur les premiers coups, là où elles décident du sort de la partie.
...
**Le livre d'ouverture reste indispensable.** Au tout début de partie le plateau offre 60 à 95 coups légaux, et la recherche en direct n'y dépasse pas la profondeur 4. Le livre, calculé hors ligne à profondeur 6, donne gratuitement deux tours d'anticipation là où ils manquent le plus. Mesuré à ouverture imposée, sur 12 ouvertures distinctes de l'adversaire, sans aucun aléa, les deux camps étant le même moteur au même budget et seul le premier coup de l'ordinateur changeant : **12 victoires sur 12 avec le livre, 6 sur 12 sans**. Le coup du livre n'est jamais moins bon que celui de la recherche en direct lorsqu'on note les deux à profondeur égale ; il est meilleur dans 10 cas sur 12.
