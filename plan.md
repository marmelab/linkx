...
**Le maître ouvre sur un livre.** Le plafond ci-dessus laisse le tout début de partie à la profondeur 2 — trop court pour distinguer un bon coup d'un coup perdant quand le plateau offre 60 à 95 coups, si bien qu'une recherche en direct y joue parfois un coup qui perd la partie plusieurs demi-coups plus tard sans le voir. Pour ses **deux premiers coups seulement**, le **maître** ne cherche donc pas : il lit un livre d'ouverture précalculé **hors ligne** à profondeur 5 ou plus, là où le temps de réflexion ne compte pas. Passé ce point, le plateau s'est resserré et la recherche en direct reprend. Le livre ne réduit les positions que par le **miroir gauche-droite**, seule symétrie que la gravité respecte, et ne couvre au deuxième coup que les réponses adverses les plus plausibles ; partout ailleurs, retour à la recherche. Les niveaux plus faibles n'y touchent pas — c'est du jeu quasi parfait, réservé au plus fort. Le livre est une **donnée générée** et reste local ; vide, le maître se rabat simplement sur la recherche, sans changer de comportement par ailleurs.
