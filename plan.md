...
**Sonde.** À tout moment, l'auteur peut demander à la plateforme d'appeler son IA sur une **position d'essai**. La réponse est immédiate et tient en une ligne : soit « OK », avec le coup renvoyé et le temps de réponse, soit le **motif d'échec exact**, dans le même vocabulaire que les défaites techniques. C'est l'outil de mise au point, et il doit rester utilisable sur une IA en sommeil comme sur une IA en qualification.
